...
export const Navigator = () => {
  ...
  // Add this state to handle mobile view
  ...
  return (
    ...
    <>
      <nav className={styles.navigation}>
        ...
        <div className={styles.mainNav}>
          {/* Mobile Menu Button - Will only show on mobile */}
          <button
        ...
        <div className={styles.mobileMenuContent}>
          ...
          <div className={styles.mobileSearchBar}>
            <input
              ...
              disabled={isProcessing}
            />
            <div className={styles.mobileSearchControls}>
              <button
          ...
          <div className={styles.mobileNavSection}>
            ...
            <div className={styles.mobileNavLinks}>
              ...
              <Link href={`/wishlist/${cartId}`} onClick={closeMobileMenu}>
                <svg viewBox="0 0 24 24">
                  <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                </svg>
                Wishlist
          ...
          <div className={styles.mobileNavSection}>
            ...
            <div className={styles.mobileNavLinks}>
              ...
              <Link href="/invoice" onClick={closeMobileMenu}>
                <svg viewBox="0 0 24 24">
                  <rect x="3" y="8" width="18" height="14" rx="2" />
                  <path d="M12 8V22" />
                  <path d="M19 8V5a2 2 0 0 0-2-2h-2.5" />
